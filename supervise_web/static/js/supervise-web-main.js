...
function onDaemonRowClicked(event) {
    ...
    $('#daemon-single-view').load('/daemon/' + daemonId + '/_details', onDetailsViewLoaded);
}
...
$(document).on('ready', function () {
    ...
    $(document).on('mousedown', '.daemon-actions button', function () {
        stopRefreshing();
    });

    $(document).on('mouseup', '.daemon-actions button', function () {
        startRefreshing();
